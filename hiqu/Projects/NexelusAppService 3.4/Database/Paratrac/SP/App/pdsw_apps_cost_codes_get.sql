/****** Object:  StoredProcedure [dbo].[pdsw_apps_cost_codes_get]   Script Date: 02/04/2015 11:58:23 ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[pdsw_apps_cost_codes_get]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[pdsw_apps_cost_codes_get]  
GO
...
CREATE PROCEDURE [dbo].[pdsw_apps_cost_codes_get]
  @company_code int            
