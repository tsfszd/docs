...
IF  EXISTS (SELECT * FROM sys.views WHERE object_id = OBJECT_ID(N'[dbo].[plv_entity_change_notify]'))
DROP VIEW [dbo].[plv_entity_change_notify]
GO

CREATE VIEW [dbo].[plv_entity_change_notify]     
/* ****************************************************************** *     
...
SELECT * from eSM912TE_SIGNUK_AX..pdd_entity_change_log  
