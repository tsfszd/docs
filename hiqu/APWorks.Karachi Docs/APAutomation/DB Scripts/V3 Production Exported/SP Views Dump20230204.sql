...
--
-- Host: auroraprod.cluster-caridxswhlir.us-east-1.rds.amazonaws.com    Database: prod_apautomation_dentsux
-- ------------------------------------------------------
...
--
-- Temporary table structure for view `v_InvoiceDocument`
--

DROP TABLE IF EXISTS `v_InvoiceDocument`;
/*!50001 DROP VIEW IF EXISTS `v_InvoiceDocument`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE TABLE `v_InvoiceDocument` (
  `company_code` tinyint NOT NULL,
  `invoice_document_id` tinyint NOT NULL,
  `invoice_document_file_location` tinyint NOT NULL,
  `invoice_document_status_id` tinyint NOT NULL,
  `invoice_document_status_attribute` tinyint NOT NULL,
  `duplicate_invoice_flag` tinyint NOT NULL,
  `master_document_model_id` tinyint NOT NULL,
  `document_model_request_id` tinyint NOT NULL,
  `vendor_code` tinyint NOT NULL,
  `site_id` tinyint NOT NULL,
  `invoice_number` tinyint NOT NULL,
  `invoice_date` tinyint NOT NULL,
  `due_date` tinyint NOT NULL,
  `service_term_start_date` tinyint NOT NULL,
  `service_term_end_date` tinyint NOT NULL,
  `payment_term_code` tinyint NOT NULL,
  `currency_code` tinyint NOT NULL,
  `po_code` tinyint NOT NULL,
  `replaced_by_invoice_document_file_location` tinyint NOT NULL,
  `transaction_id` tinyint NOT NULL,
  `model_def_id` tinyint NOT NULL,
  `create_id` tinyint NOT NULL,
  `create_date` tinyint NOT NULL,
  `modify_id` tinyint NOT NULL,
  `modify_date` tinyint NOT NULL,
  `TotalAmount` tinyint NOT NULL,
  `request_to_map` tinyint NOT NULL,
  `manual_processing` tinyint NOT NULL,
  `invoice_document_scan_status_id` tinyint NOT NULL,
  `manual_upload_flag` tinyint NOT NULL,
  `invoice_document_posting_status_id` tinyint NOT NULL,
  `invoice_document_posting_error_message` tinyint NOT NULL,
  `vendor_name` tinyint NOT NULL,
  `short_name` tinyint NOT NULL,
  `routing_history_count` tinyint NOT NULL
) ENGINE=MyISAM */;
SET character_set_client = @saved_cs_client;

--
-- Temporary table structure for view `v_InvoiceModel`
--

DROP TABLE IF EXISTS `v_InvoiceModel`;
/*!50001 DROP VIEW IF EXISTS `v_InvoiceModel`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE TABLE `v_InvoiceModel` (
  `company_code` tinyint NOT NULL,
  `document_model_request_id` tinyint NOT NULL,
  `invoice_document_file_location` tinyint NOT NULL,
  `manual_upload_flag` tinyint NOT NULL,
  `master_document_model_id` tinyint NOT NULL,
  `document_model_name` tinyint NOT NULL,
  `document_model_name_tag` tinyint NOT NULL,
  `document_model_status_id` tinyint NOT NULL,
  `document_model_is_active` tinyint NOT NULL,
  `invoice_document_sample_file_location` tinyint NOT NULL,
  `invoice_document_id` tinyint NOT NULL,
  `vendor_code` tinyint NOT NULL,
  `vendor_name` tinyint NOT NULL,
  `short_name` tinyint NOT NULL,
  `site_id` tinyint NOT NULL,
  `vendor_status_id` tinyint NOT NULL,
  `vendor_status_name` tinyint NOT NULL
) ENGINE=MyISAM */;
SET character_set_client = @saved_cs_client;

--
-- Temporary table structure for view `v_InvoiceModelByDocumentModel`
--

DROP TABLE IF EXISTS `v_InvoiceModelByDocumentModel`;
/*!50001 DROP VIEW IF EXISTS `v_InvoiceModelByDocumentModel`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE TABLE `v_InvoiceModelByDocumentModel` (
  `company_code` tinyint NOT NULL,
  `document_model_request_id` tinyint NOT NULL,
  `invoice_document_file_location` tinyint NOT NULL,
  `manual_upload_flag` tinyint NOT NULL,
...
--
-- Temporary table structure for view `v_InvoiceModelByMasterDocumentModel`
--

DROP TABLE IF EXISTS `v_InvoiceModelByMasterDocumentModel`;
/*!50001 DROP VIEW IF EXISTS `v_InvoiceModelByMasterDocumentModel`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE TABLE `v_InvoiceModelByMasterDocumentModel` (
  `company_code` tinyint NOT NULL,
  `document_model_request_id` tinyint NOT NULL,
  `invoice_document_file_location` tinyint NOT NULL,
  `manual_upload_flag` tinyint NOT NULL,
...
--
-- Temporary table structure for view `v_PODetail`
--

DROP TABLE IF EXISTS `v_PODetail`;
/*!50001 DROP VIEW IF EXISTS `v_PODetail`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE TABLE `v_PODetail` (
  `company_code` tinyint NOT NULL,
  `po_code` tinyint NOT NULL,
  `level2_key` tinyint NOT NULL,
  `level3_key` tinyint NOT NULL,
  `cost_category` tinyint NOT NULL,
  `quantity` tinyint NOT NULL,
  `net_cost` tinyint NOT NULL,
  `match_to_date_net` tinyint NOT NULL,
  `remaining_amount` tinyint NOT NULL,
  `customer_name` tinyint NOT NULL,
  `level2_description` tinyint NOT NULL,
  `po_required_flag` tinyint NOT NULL,
  `tolerance_po_amount` tinyint NOT NULL,
  `tolerance_po_flag` tinyint NOT NULL
) ENGINE=MyISAM */;
SET character_set_client = @saved_cs_client;

--
-- Temporary table structure for view `v_ResourcesByInvoiceDocument`
--

DROP TABLE IF EXISTS `v_ResourcesByInvoiceDocument`;
/*!50001 DROP VIEW IF EXISTS `v_ResourcesByInvoiceDocument`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE TABLE `v_ResourcesByInvoiceDocument` (
  `company_code` tinyint NOT NULL,
  `resource_id` tinyint NOT NULL,
  `name_last` tinyint NOT NULL,
  `name_first` tinyint NOT NULL,
  `name_init` tinyint NOT NULL,
  `title` tinyint NOT NULL,
  `email` tinyint NOT NULL,
  `login_id` tinyint NOT NULL,
  `res_password` tinyint NOT NULL,
  ...
  `invoice_document_status_id` tinyint NOT NULL,
  `model_def_id` tinyint NOT NULL,
  `position_category_code` tinyint NOT NULL,
  `position_category_name` tinyint NOT NULL,
  `protected_role_flag` tinyint NOT NULL
) ENGINE=MyISAM */;
SET character_set_client = @saved_cs_client;

--
-- Temporary table structure for view `v_lookup_apam_currencies`
--
...
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE TABLE `v_lookup_apam_currencies` (
  `apa_code` tinyint NOT NULL,
  `erp_code` tinyint NOT NULL
) ENGINE=MyISAM */;
SET character_set_client = @saved_cs_client;

--
-- Temporary table structure for view `v_lookup_apam_payment_terms`
--
...
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE TABLE `v_lookup_apam_payment_terms` (
  `apa_code` tinyint NOT NULL,
  `erp_code` tinyint NOT NULL
) ENGINE=MyISAM */;
SET character_set_client = @saved_cs_client;
...
--
-- Dumping routines for database 'prod_apautomation_dentsux'
--
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
CREATE DEFINER=`admin`@`%` PROCEDURE `apas_allcostcodes_list`(
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
CREATE DEFINER=`admin`@`%` PROCEDURE `apas_alllevel2resources_list`(
	IN company_code_param   INT,
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
CREATE DEFINER=`admin`@`%` PROCEDURE `apas_alllevel2_list`(
	IN company_code_param   INT
)
BEGIN
	SELECT
	...
	FROM
		apad_level2 l2
		INNER JOIN prod_apautomation_common.apai_level2_status l2s ON l2.level2_status_id = l2s.level2_status_id
	WHERE
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
CREATE DEFINER=`admin`@`%` PROCEDURE `apas_alllevel3_list`(
	IN company_code_param   INT,
	IN level2_key_param     VARCHAR(32)
)
BEGIN
	...
	FROM
		apad_level3 l3
		INNER JOIN prod_apautomation_common.apai_level3_status l3s ON l3.level3_status_id = l3s.level3_status_id
	WHERE
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
CREATE DEFINER=`admin`@`%` PROCEDURE `apas_appayment_list`(
	IN company_code_param INT
)
BEGIN
	SELECT
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
CREATE DEFINER=`faisalf`@`%` PROCEDURE `apas_appayment_save`(
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
CREATE DEFINER=`admin`@`%` PROCEDURE `apas_approvalstampconfiguration_get`(
	IN company_code_param               INT,
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
CREATE DEFINER=`admin`@`%` PROCEDURE `apas_approvalstampconfiguration_save`(
	IN company_code_param               INT,
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
CREATE DEFINER=`admin`@`%` PROCEDURE `apas_companyapprovalconfiguration_save`(
	IN company_code_param                                   INT,
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
CREATE DEFINER=`admin`@`%` PROCEDURE `apas_companyinvoiceconfiguration_save`(
	IN company_code_param                                   INT,
	IN model_def_id_param                                   INT UNSIGNED,
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
CREATE DEFINER=`admin`@`%` PROCEDURE `apas_company_add`(
	IN company_code_param                                   INT,
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
CREATE DEFINER=`admin`@`%` PROCEDURE `apas_company_delete`(
	IN company_code_param INT
)
BEGIN
	DELETE FROM
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
CREATE DEFINER=`admin`@`%` PROCEDURE `apas_company_get`(
	IN company_code_param INT
)
BEGIN
	DECLARE u_one INT;
	...
	FROM
		prod_apautomation_common.apai_model_def md
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
CREATE DEFINER=`admin`@`%` PROCEDURE `apas_company_list`()
BEGIN
	SELECT
		company_code,
		co_short_name, 
	...
	FROM
		...
		INNER JOIN prod_apautomation_common.apai_model_def md ON md.model_def_id = c.model_def_id;
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
CREATE DEFINER=`admin`@`%` PROCEDURE `apas_company_update`(
	IN company_code_param                                   INT,
	IN co_short_name_param                                  VARCHAR(16),
	IN co_name_param                                        VARCHAR(64), 
	IN currency_code_param                                  CHAR(8),
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
CREATE DEFINER=`admin`@`%` PROCEDURE `apas_company_updateemailreminderlastexecutiondate`(
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
CREATE DEFINER=`admin`@`%` PROCEDURE `apas_costcodes_list`(
	IN company_code_param   INT,
	IN level2_key_param     VARCHAR(32),
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
CREATE DEFINER=`admin`@`%` PROCEDURE `apas_costcodes_save`(
	valuesCSV           VARCHAR(65535),
	update_date_param   DATETIME
)
BEGIN
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
CREATE DEFINER=`admin`@`%` PROCEDURE `apas_costtypes_list`(
	IN company_code_param   INT
)
BEGIN
	SELECT
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
CREATE DEFINER=`admin`@`%` PROCEDURE `apas_costtypes_save`(
	valuesCSV           VARCHAR(65535),
	update_date_param   DATETIME
)
BEGIN
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
CREATE DEFINER=`admin`@`%` PROCEDURE `apas_currenciesmap_add`(
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
CREATE DEFINER=`admin`@`%` PROCEDURE `apas_currenciesmap_delete`(
	IN currency_code_param CHAR(8)
)
BEGIN
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
CREATE DEFINER=`admin`@`%` PROCEDURE `apas_currenciesmap_get`(
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
CREATE DEFINER=`admin`@`%` PROCEDURE `apas_currencies_list`(
)
BEGIN
	SELECT
		currency_code,
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
CREATE DEFINER=`admin`@`%` PROCEDURE `apas_currency_save`(
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
CREATE DEFINER=`admin`@`%` PROCEDURE `apas_dashboard_pendingapprovalorapprovedinvoice_list`(
	IN company_code_param       INT,
	IN model_def_id_param       INT UNSIGNED,
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
CREATE DEFINER=`admin`@`%` PROCEDURE `apas_dashboard_pendingapprovalorapprovedinvoice_list_tl`(
	IN company_code_param       INT,
	IN model_def_id_param       INT UNSIGNED,
	IN user_role_id_param       INT,
	IN resource_id_param        CHAR(16),
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
CREATE DEFINER=`faisalf`@`%` PROCEDURE `apas_dashboard_scannedinvoice_list`(
	IN company_code_param       INT,
	IN model_def_id_param       INT UNSIGNED,
	IN resource_id_param        CHAR(16),
	IN weeks_to_filter_param    INT
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
CREATE DEFINER=`admin`@`%` PROCEDURE `apas_datalastupdated_get`(
	IN company_code_param  INT,
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
CREATE DEFINER=`admin`@`%` PROCEDURE `apas_datalastupdated_update`(
	IN company_code_param   INT,
	IN table_name_param     VARCHAR(32),
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
CREATE DEFINER=`faisalf`@`%` PROCEDURE `apas_datasearchservice_get`(
	IN company_code_param       INT,
	valuesCSV           VARCHAR(65535)
)
BEGIN
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
CREATE DEFINER=`admin`@`%` PROCEDURE `apas_documentmodelfielddetail_add`(
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
CREATE DEFINER=`admin`@`%` PROCEDURE `apas_documentmodelfielddetail_delete`(
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
CREATE DEFINER=`admin`@`%` PROCEDURE `apas_documentmodelfielddetail_update`(
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
CREATE DEFINER=`admin`@`%` PROCEDURE `apas_documentmodelfield_add`(
	IN company_code_param                   INT,
	IN master_document_model_id_param       INT UNSIGNED,
	IN master_document_model_field_id_param INT UNSIGNED,
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
CREATE DEFINER=`admin`@`%` PROCEDURE `apas_documentmodelfield_update`(
	IN company_code_param                   INT,
	IN master_document_model_id_param       INT UNSIGNED,
	IN master_document_model_field_id_param INT UNSIGNED,
	IN default_value_param                  VARCHAR(32)
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
CREATE DEFINER=`admin`@`%` PROCEDURE `apas_documentmodelrequest_add`(
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
CREATE DEFINER=`admin`@`%` PROCEDURE `apas_documentmodel_add`(
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
CREATE DEFINER=`admin`@`%` PROCEDURE `apas_documentmodel_get`(
	IN company_code_param               INT,
	IN master_document_model_id_param   INT UNSIGNED
)
BEGIN
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
CREATE DEFINER=`admin`@`%` PROCEDURE `apas_documentmodel_setactive`(
	IN company_code_param                            INT,
	IN master_document_model_id_param                INT UNSIGNED,
	IN document_model_is_active_param                CHAR(1),
	IN modify_id_param                               VARCHAR(32),
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
CREATE DEFINER=`admin`@`%` PROCEDURE `apas_documentmodel_update`(
	IN company_code_param                            INT,
	IN master_document_model_id_param                INT UNSIGNED,
	IN document_model_name_param                     VARCHAR(64),
	IN document_model_name_tag_param                 VARCHAR(32),
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
CREATE DEFINER=`faisalf`@`%` PROCEDURE `apas_email_log_write`(
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
CREATE DEFINER=`admin`@`%` PROCEDURE `apas_invoicedocumentdetail_add`(
	IN company_code_param           INT,
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
CREATE DEFINER=`admin`@`%` PROCEDURE `apas_invoicedocumentdetail_delete`(
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
CREATE DEFINER=`faisalf`@`%` PROCEDURE `apas_invoicedocumentdetail_list`(
	IN company_code_param   INT,
	IN model_def_id_param   INT UNSIGNED
)
BEGIN
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
CREATE DEFINER=`admin`@`%` PROCEDURE `apas_invoicedocumentdetail_update`(
	IN company_code_param           INT,
	IN invoice_document_id_param    INT UNSIGNED,
	IN seq_id_param                 INT UNSIGNED,
	IN io_number_param              VARCHAR(64),
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
CREATE DEFINER=`zeeshana`@`%` PROCEDURE `apas_invoicedocumentdetail_verify`(
	IN company_code_param   INT,
	IN po_code_param        VARCHAR(32),
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
CREATE DEFINER=`faisalf`@`%` PROCEDURE `apas_invoicedocumenteditor_get`(
	IN company_code_param        INT,
	IN invoice_document_id_param INT UNSIGNED
)
BEGIN
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
CREATE DEFINER=`admin`@`%` PROCEDURE `apas_invoicedocumenteditor_getbyfilename`(
	IN company_code_param                   INT,
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
CREATE DEFINER=`admin`@`%` PROCEDURE `apas_invoicedocumentresourcenotification_bulkupdate`(
	valuesCSV   VARCHAR(65535)
)
BEGIN
	DROP TEMPORARY TABLE IF EXISTS _temp;
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
CREATE DEFINER=`admin`@`%` PROCEDURE `apas_invoicedocumentresourcenotification_getbynumberofdays`(
	IN company_code_param   INT,
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
CREATE DEFINER=`admin`@`%` PROCEDURE `apas_invoicedocumentresourceroutinghistory_add`(
	IN company_code_param           INT,
	IN invoice_document_id_param	INT UNSIGNED,
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
CREATE DEFINER=`admin`@`%` PROCEDURE `apas_invoicedocumentroutinghistory_add`(
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
CREATE DEFINER=`admin`@`%` PROCEDURE `apas_invoicedocumentroutinghistory_list`(
	IN company_code_param           INT,
	IN invoice_document_id_param    INT UNSIGNED
)
BEGIN
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
CREATE DEFINER=`admin`@`%` PROCEDURE `apas_invoicedocuments_postinprogress`(
	IN company_code_param                           INT,
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
CREATE DEFINER=`faisalf`@`%` PROCEDURE `apas_invoicedocument_add`(
	IN company_code_param                      INT,
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
CREATE DEFINER=`faisalf`@`%` PROCEDURE `apas_invoicedocument_list`(
	IN company_code_param   INT,
	IN model_def_id_param   INT UNSIGNED
)
BEGIN
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
CREATE DEFINER=`admin`@`%` PROCEDURE `apas_invoicedocument_setdeleted`(
	IN company_code_param                               INT,
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
CREATE DEFINER=`admin`@`%` PROCEDURE `apas_invoicedocument_update`(
	IN company_code_param                      INT,
	IN invoice_document_id_param               INT UNSIGNED,
	IN invoice_document_file_location_param    VARCHAR(1024),
	IN invoice_document_status_id_param        INT UNSIGNED,
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
CREATE DEFINER=`admin`@`%` PROCEDURE `apas_invoicedocument_updatebymasterdocumentmodel`(
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
CREATE DEFINER=`faisalf`@`%` PROCEDURE `apas_invoicedocument_updatestatus`(
	IN company_code_param                           INT,
	IN invoice_document_id_param                    INT,
	IN invoice_document_status_id_param             INT UNSIGNED,
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
CREATE DEFINER=`faisalf`@`%` PROCEDURE `apas_invoicedocument_verifyduplication`(
	IN company_code_param                      INT,
	IN invoice_document_id_param               INT UNSIGNED,
	IN vendor_code_param                       VARCHAR(12),
	IN site_id_param                           VARCHAR(32),
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
CREATE DEFINER=`admin`@`%` PROCEDURE `apas_invoicemodel_list`(
	IN company_code_param   INT,
	IN model_def_id_param   INT UNSIGNED
)
BEGIN
	...
	SELECT
		...
		v.site_id
	FROM
		prod_apautomation_common.apam_master_document_model mdm
	...
	FROM
		...
		INNER JOIN apad_invoice_document id ON id.document_model_request_id = dmr.document_model_request_id
													...
													AND id.model_def_id = model_def_id_param
		LEFT OUTER JOIN prod_apautomation_common.apam_master_document_model mdm ON mdm.master_document_model_id = id.master_document_model_id
																				AND id.model_def_id = model_def_id_param
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
CREATE DEFINER=`admin`@`%` PROCEDURE `apas_invoicemodel_setdocumentmodelrequestcompleted`(
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
CREATE DEFINER=`admin`@`%` PROCEDURE `apas_invoicemodel_update`(
	IN company_code_param                   INT,
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
CREATE DEFINER=`admin`@`%` PROCEDURE `apas_invoicescannermonitor_getbyfilename`(
	IN company_code_param                   INT,
    IN invoice_document_file_location_param	VARCHAR(1024)
)
BEGIN
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
CREATE DEFINER=`admin`@`%` PROCEDURE `apas_level2resources_save`(
	valuesCSV           VARCHAR(65535),
	update_date_param   DATETIME
)
BEGIN
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
CREATE DEFINER=`admin`@`%` PROCEDURE `apas_level2resource_list`(
	IN company_code_param           INT,
	IN invoice_document_id_param    INT UNSIGNED
)
BEGIN
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
CREATE DEFINER=`admin`@`%` PROCEDURE `apas_level2_list`(
	IN company_code_param   INT,
	IN po_code_param        VARCHAR(32),
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
CREATE DEFINER=`admin`@`%` PROCEDURE `apas_level2_save`(
	valuesCSV           VARCHAR(65535),
	update_date_param   DATETIME
)
BEGIN
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
CREATE DEFINER=`admin`@`%` PROCEDURE `apas_level3withcostcodes_list`(
	IN company_code_param   INT,
	IN level2_key_param     VARCHAR(32)
)
BEGIN
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
CREATE DEFINER=`admin`@`%` PROCEDURE `apas_level3_list`(
	IN company_code_param   INT,
	IN level2_key_param     VARCHAR(32),
	IN po_code_param        VARCHAR(32)
)
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
CREATE DEFINER=`admin`@`%` PROCEDURE `apas_level3_save`(
	valuesCSV           VARCHAR(65535),
	update_date_param   DATETIME
)
BEGIN
...
DELIMITER ;;
CREATE DEFINER=`admin`@`%` PROCEDURE `apas_masterdocumentmodelfielddetail_list`(
	IN model_def_id_param   INT UNSIGNED
)
BEGIN
	SELECT
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
CREATE DEFINER=`admin`@`%` PROCEDURE `apas_nonmappedinvoice_manuallyuploadedinvoice_add`(
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
CREATE DEFINER=`admin`@`%` PROCEDURE `apas_nonmappedinvoice_manuallyuploadedinvoice_delete`(
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
CREATE DEFINER=`admin`@`%` PROCEDURE `apas_nonmappedinvoice_manuallyuploadedinvoice_get`(
	IN company_code_param                       INT,
	IN document_manual_upload_record_id_param   INT UNSIGNED
)
BEGIN
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
CREATE DEFINER=`admin`@`%` PROCEDURE `apas_nonmappedinvoice_manuallyuploadedinvoice_list`(
	IN company_code_param       INT,
	IN model_def_id_param       INT UNSIGNED,
	IN resource_id_param        CHAR(16),
	IN weeks_to_filter_param    INT
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
CREATE DEFINER=`admin`@`%` PROCEDURE `apas_nonmappedinvoice_manuallyuploadedinvoice_update`(
	IN document_manual_upload_record_id_param           INT UNSIGNED, 
	IN company_code_param                               INT,
	IN resource_id_param                                CHAR(16),
	IN document_manual_upload_file_location_param       VARCHAR(1024),
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
CREATE DEFINER=`admin`@`%` PROCEDURE `apas_nonmappedinvoice_scannedinvoice_delete`(
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
CREATE DEFINER=`admin`@`%` PROCEDURE `apas_nonmappedinvoice_scannedinvoice_get`(
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
CREATE DEFINER=`admin`@`%` PROCEDURE `apas_nonmappedinvoice_scannedinvoice_list`(
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
CREATE DEFINER=`admin`@`%` PROCEDURE `apas_nonmappedinvoice_scannedinvoice_update`(
	IN scanner_monitor_record_id_param INT UNSIGNED,
	IN company_code_param INT,
	IN invoice_document_file_location_param VARCHAR(1024),
	IN invoice_document_scan_status_id_param INT UNSIGNED,
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
CREATE DEFINER=`admin`@`%` PROCEDURE `apas_nonmappedinvoice_scannedinvoice_updatescanstatus`(
	IN company_code_param                       INT,
	IN invoice_document_file_location_param     VARCHAR(1024),
	IN invoice_document_scan_status_id_param    INT UNSIGNED,
	IN invoice_document_scan_update_date_param  DATETIME,
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
CREATE DEFINER=`admin`@`%` PROCEDURE `apas_nonmappedinvoice_scannedinvoice_updatestatus`(
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
CREATE DEFINER=`admin`@`%` PROCEDURE `apas_nonmappedinvoice_updatedocumentmodelrequestId`(
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
CREATE DEFINER=`admin`@`%` PROCEDURE `apas_nonmappedinvoice_updateinvoicedocumentid`(
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
CREATE DEFINER=`faisalf`@`%` PROCEDURE `apas_paymentdashboard_list`(
	IN company_code_param   INT,
	IN model_def_id_param   INT UNSIGNED,
	IN user_role_id_param   INT,
	IN resource_id_param    CHAR(16)
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
CREATE DEFINER=`admin`@`%` PROCEDURE `apas_paymenttermsmap_add`(
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
CREATE DEFINER=`admin`@`%` PROCEDURE `apas_paymenttermsmap_delete`(
	IN terms_code_param CHAR(64)
)
BEGIN
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
CREATE DEFINER=`admin`@`%` PROCEDURE `apas_paymenttermsmap_get`(
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
CREATE DEFINER=`admin`@`%` PROCEDURE `apas_paymentterms_get`(
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
CREATE DEFINER=`admin`@`%` PROCEDURE `apas_paymentTerm_save`(
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
CREATE DEFINER=`faisalf`@`%` PROCEDURE `apas_podetail_list`(
	IN company_code_param   INT,
	IN po_code_param        VARCHAR(32)
)
BEGIN
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
CREATE DEFINER=`zeeshana`@`%` PROCEDURE `apas_podetail_save`(
	valuesCSV           VARCHAR(65535),
	update_date_param   DATETIME
)
BEGIN
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
CREATE DEFINER=`admin`@`%` PROCEDURE `apas_poheaderandresourcebyvendor_list`(
	IN company_code_param           INT,
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
CREATE DEFINER=`admin`@`%` PROCEDURE `apas_poheaderbypocodelist_list`(
	IN company_code_param               INT,
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
CREATE DEFINER=`zeeshana`@`%` PROCEDURE `apas_poheaderbyvendor_list`(
	IN company_code_param               INT,
	IN vendor_code_param                CHAR(12),
	IN site_id_param                    CHAR(32),
	IN service_term_start_date_param    DATE,
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
CREATE DEFINER=`admin`@`%` PROCEDURE `apas_poheader_list`(
	IN company_code_param   INT,
	IN model_def_id_param   INT UNSIGNED
)
BEGIN
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
CREATE DEFINER=`faisalf`@`%` PROCEDURE `apas_poresources_list`(
	IN company_code_param   INT,
	IN po_code_param        VARCHAR(32),
	IN resource_id_param    CHAR(16)
)
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
CREATE DEFINER=`admin`@`%` PROCEDURE `apas_position_category_list`(
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
CREATE DEFINER=`admin`@`%` PROCEDURE `apas_position_category_save`(
	companyCode                 INT,
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
CREATE DEFINER=`admin`@`%` PROCEDURE `apas_po_header_get`(
	IN company_code_param   INT,
	IN po_code_param        VARCHAR(32)
)
BEGIN
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
CREATE DEFINER=`zeeshana`@`%` PROCEDURE `apas_po_header_save`(
	valuesCSV           VARCHAR(65535),
	update_date_param   DATETIME
)
BEGIN
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
CREATE DEFINER=`admin`@`%` PROCEDURE `apas_po_media_delivery_save`(
	valuesCSV           VARCHAR(65535),
	update_date_param   DATETIME
)
BEGIN
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
CREATE DEFINER=`admin`@`%` PROCEDURE `apas_po_resource_save`(
	valuesCSV           VARCHAR(65535),
	update_date_param   DATETIME
)
BEGIN
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
CREATE DEFINER=`admin`@`%` PROCEDURE `apas_registration_get`(
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
CREATE DEFINER=`admin`@`%` PROCEDURE `apas_resources_add`(
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
CREATE DEFINER=`faisalf`@`%` PROCEDURE `apas_resources_authenticate`(
	IN login_id_param       	VARCHAR(64),
	IN res_password_param   	VARCHAR(256),
	IN email_param          	VARCHAR(128),
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
CREATE DEFINER=`admin`@`%` PROCEDURE `apas_resources_delete`(
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
CREATE DEFINER=`faisalf`@`%` PROCEDURE `apas_resources_get_by_invoice_document`(
	IN company_code_param           INT,
	IN invoice_document_id_param    INT UNSIGNED,
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
CREATE DEFINER=`admin`@`%` PROCEDURE `apas_resources_get_by_level2`(
	IN company_code_param                   INT,
	IN invoice_document_file_location_param VARCHAR(1024),
	IN level2_key_param                     VARCHAR(32),
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
CREATE DEFINER=`admin`@`%` PROCEDURE `apas_resources_get_by_po_header`(
	IN company_code_param                   INT,
	IN invoice_document_file_location_param VARCHAR(1024),
	IN po_code_param                        VARCHAR(32),
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
CREATE DEFINER=`admin`@`%` PROCEDURE `apas_resources_get_by_resources`(
	IN company_code_param                   INT,
	IN invoice_document_file_location_param VARCHAR(1024),
	IN resource_id_param                    CHAR(16),
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
CREATE DEFINER=`admin`@`%` PROCEDURE `apas_resources_list`(
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
CREATE DEFINER=`admin`@`%` PROCEDURE `apas_resources_reset_password`(
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
CREATE DEFINER=`admin`@`%` PROCEDURE `apas_resources_update`(
	IN company_code_param INT,
	IN resource_id_param  CHAR(16),
	IN name_last_param    VARCHAR(32),
	IN name_first_param   VARCHAR(32),
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
CREATE DEFINER=`faisalf`@`%` PROCEDURE `apas_resource_save`(
	valuesCSV           VARCHAR(65535),
	update_date_param   DATETIME
)
BEGIN
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`admin`@`%` PROCEDURE `apas_updateinvoicedocumentscanstatus`(
	IN company_code_param INT,
	IN invoice_document_file_location_param VARCHAR(1024),
	IN invoice_document_scan_status_id_param INT UNSIGNED
)
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
CREATE DEFINER=`admin`@`%` PROCEDURE `apas_updateinvoicedocumentstatus`(
	IN company_code_param INT,
	IN invoice_document_file_location_param VARCHAR(1024),
	IN invoice_document_scan_status_id_param INT UNSIGNED
)
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
CREATE DEFINER=`admin`@`%` PROCEDURE `apas_userrolesinvoicerights_save`(
	IN company_code_param									INT,
	IN user_role_id_param									INT,
	IN model_def_id_param									INT UNSIGNED,
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
CREATE DEFINER=`admin`@`%` PROCEDURE `apas_userroles_add`(
	IN company_code_param			INT,
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
CREATE DEFINER=`admin`@`%` PROCEDURE `apas_userroles_delete`(
	IN company_code_param   INT,
	IN user_role_id_param   INT
)
BEGIN
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
CREATE DEFINER=`admin`@`%` PROCEDURE `apas_userroles_list`(
	IN company_code_param INT
)
BEGIN
	SELECT
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
CREATE DEFINER=`admin`@`%` PROCEDURE `apas_userroles_update`(
	IN company_code_param			INT,
	IN user_role_id_param			INT,
	IN user_role_name_param			VARCHAR(64),
	IN is_admin_role_param			CHAR(1),
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
CREATE DEFINER=`admin`@`%` PROCEDURE `apas_user_roles_resource_add`(
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
CREATE DEFINER=`admin`@`%` PROCEDURE `apas_user_roles_resource_delete`(
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
CREATE DEFINER=`admin`@`%` PROCEDURE `apas_user_roles_resource_get`(
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
CREATE DEFINER=`admin`@`%` PROCEDURE `apas_user_role_position_categories_add`(
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
CREATE DEFINER=`admin`@`%` PROCEDURE `apas_user_role_position_categories_delete`(
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
CREATE DEFINER=`admin`@`%` PROCEDURE `apas_vendor_list`(
	IN company_code_param INT
)
BEGIN
	SELECT
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
CREATE DEFINER=`zeeshana`@`%` PROCEDURE `apas_vendor_save`(
	valuesCSV           VARCHAR(65535),
	update_date_param   DATETIME
)
BEGIN
...
/*!50013 DEFINER=`faisalf`@`%` SQL SECURITY DEFINER */
